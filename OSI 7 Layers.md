...
- 서로 다른 기기들이 어떤 방식으로 통신을 할지 세션을 만들어서 처리
- 

### 6계층 - 표현계층(Presentation Layer)
- 주로 암호화 또는 번역 등의 기능을 수행

### 7계층 - 응용계층(Applications Layer)
- 응용 프로그램과 통신 프로그램 간의 인터페이스를 제공한다

### 정리
> A에서 B에게 "안녕하세요"라고 정보를 보내면

- 7계층 - "안녕하세요"라는 정보와 어떤 프로그램을 썼는지 인코딩
- 6계층 - 받아 온 프로그램 정보와 "안녕하세요" 정보를 암호화
- 5계층 - 받아 온 정보를 어떤 통신방식으로 사용할지 정함
- 4계층 - 받아 온 정보를 어떤 포트를 사용할지 정함
- 3계층 - 정보를 받아 어디로 보낼지 정함. 그때 사용되는 것 IP 주소
- 2계층 - 3계층이 보낸 정보를 토대로 다른 데이터와 섞이지 않도록 경계를 지어줌
- 1계층 - 이러한 정보를 전기적 신호로 보냄
